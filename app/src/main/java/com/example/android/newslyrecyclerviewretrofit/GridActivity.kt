...
class GridActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGridBinding//Data Binding -1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_grid)//Data Binding -2
        adapter = NewsAdapter(this@GridActivity, articles)
        var recyclerView = binding.rcvGrid
        recyclerView.adapter = adapter//Data Binding -3
        //-------------------------------------------------------------------------
        //first change to simple Recyclerviewin XML file
        recyclerView.layoutManager =
            GridLayoutManager(applicationContext, 2)//Grid View scroll logic
        //-------------------------------------------------------------------------
