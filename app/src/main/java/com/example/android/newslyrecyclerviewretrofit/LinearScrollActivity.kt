 ...
 override fun onCreate(savedInstanceState: Bundle?) {
     ...
     recyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
         override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
             ...
             val firstVisibleItemPosition = linearLayoutManager.findFirstVisibleItemPosition()//give position of 1st visible item
             val TotalCount = linearLayoutManager.itemCount//give total count of all news
             val firstVisibleItemView = linearLayoutManager.findViewByPosition(firstVisibleItemPosition)
